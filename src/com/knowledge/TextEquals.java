...
public class TextEquals {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("self class equals: " + textEquals1.equals(textEquals2));
        System.out.println("String equals " + string1.equals(string2));
        System.out.println("arrays equals " + arrint1.equals(arrint2));
        System.out.println("int equals " + ((Integer)a).equals(3));

        System.out.println(Objects.equals(string1, string2));
        System.out.println(Objects.equals(textEquals1, textEquals2));
        /**
         * 结论：Object类中的equals方法默认比较的的是两个对象变量的引用值是否相等，即是否为同一变量；
         * 所以：在使用equals方法时，如果调用的对象是自定义的类，而又没有重写equals方法，则比较的是引用值
         *       在使用由java类库中的类所产生的实例调用equals方法时，一定要查明该实例是否重写了equals方法；
         * 注意：String类中重写了equals方法，使其功能为：如果两个String实例变量的引用的内容相等，则结果为true
         *       数组类型数据虽然作为对象处理，但是没有为其重写Object类的equals方法。
         *       对于基本数据类型，必须先将其转化为类类型才可以调用equals方法，结果比较的是值是否相等。
         */
